        ...
        switch j
            case 1
                ...
                if (cbd_i ~= -1)
                    ...
                    b(j) = -Q*h - (2*k/h)*cbd_i - (1/2)*v* cbd_i + temp_t(j,i)*h/dt + ant1;%Parte de la actual mas parte del tiempo anterior
                else
                    if (cbn_i ~= -1)
                        %Condicion Neumann
...
plot(temp_t(:,6),'r');
plot(temp_t(:,cant_pasos_tiempo),'b');